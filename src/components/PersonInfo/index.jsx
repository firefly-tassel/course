...
class PersonInfo extends Component {
    render() {
        const { avatar, job, telephone, mail, orientation, address, home } = this.props;
        return (
            <div className={personInfoStyles.person}>
                <Descriptions column={2} bordered={true} size="middle">
                    ...
                    <Descriptions.Item label="职务">{job}</Descriptions.Item>
                    ...
                    <Descriptions.Item label="个人主页"><a href={home} target="view_window">{home}</a></Descriptions.Item>
                </Descriptions>
            </div>
        );
    }
